...
//        
//        // TODO I don't think we need to work with the Generalized Deligne Module
//        // use instead isog`glueing_gen_deligne_module_data and then act with the invertible part
...
//        // K_p:=pPartDeltaInverseIdeal(isog,Mv);
...
//        aa:=K+J;
//        bb:=K meet J;
//        supp:=PrimesAbove(ColonIdeal(bb,aa) meet OneIdeal(R)); // the support of the finite R-module aa/bb
...
//            Iv:=P_ll^k_ll * J + &*[supp[i]^ks_supp[i]:i in [1..#supp]]*K;
//        end if;
