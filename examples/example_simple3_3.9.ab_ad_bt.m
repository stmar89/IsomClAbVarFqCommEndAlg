...
*/
    ...
    printf "We have precomputed the isomorphism classes and we load them in the previous 5 lines of code.\nTo recompute them, which takes approximatively 10 minutes, comment the previous 5 lines out and uncomment the next line";
    //iso:=IsomorphismClasses(isog);

    R:=ZFVOrder(isog);
    Q,mQ,F,V,dJ,m0,J:=SemilinearOperators(isog);
    E:=Algebra(R);
